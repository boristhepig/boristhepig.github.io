...
using MGRescue_System.Reliability;
...
namespace MySendGrid
{
    ...
    public class SendGridClient : ISendGridClient
    {
        ...
        internal async Task<Response> SendEmailAsync(ContactViewModel con, CancellationToken cancellationToken = default(CancellationToken))
        {
